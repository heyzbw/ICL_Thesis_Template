...
\usepackage[english]{babel} %设置英文单词的断行规则；
\linespread{1.5}%全文1.5倍行距；
\newfontface\englishbf{Times New Roman}[Contextuals={WordInitial,WordFinal}] %设置英文大写方式；
%========================电子文档与超链接======================
...
\hypersetup{
 ...
 pdfstartview = Fit,
 pdftitle = {coursework1_report_CID},
 pdfauthor = {Bowen Zhi}
}
...
% \pagestyle{fancy}
% \fancyhf{}
% \lhead{\includegraphics[scale=0.04]{./pictures/ICL_logo.png}}
% \usepackage{lastpage}
% \rhead{\small\heiti Reinforcement Learning Coursework(Report)}
% %===============================================================
...
% \titleformat{\section}[hang]{\heiti\Large}{Chapter\ \thesection \quad}{0pt}{}{}
...
\lhead{\includegraphics[scale=0.04]{./pictures/ICL_logo.png}}  % Set logo in the left header
\rhead{\small\heiti Reinforcement Learning Coursework (Report)}  % Set custom right header text
%===============================================================
...
\titleformat{\section}[hang]
  {\englishbf\Large}  % Bold and large font for section title
  {Chapter\ \thesection\quad}  % Add 'Chapter' before section number
  {0pt}  % No space between number and title
  {}  % No extra formatting
\titlespacing*{\section}{0pt}{0pt}{19.2pt}[0pt]  % Adjust spacing around section title

\titleformat{\subsection}[hang]
  {\englishbf\normalsize\raggedright}  % Bold and normal font for subsection title
  {\thesubsection\quad}  % Subsection number formatting
  {0pt}  % No space between number and title
  {}  % No extra formatting
\titlespacing*{\subsection}{0pt}{0pt}{0pt}[0pt]  % Adjust spacing around subsection title

\titleformat{\subsubsection}[hang]
  {\itshape\normalsize\raggedright}  % Italic font for subsubsection title
  {\thesubsubsection\quad}  % Subsubsection number formatting
  {0pt}  % No space between number and title
  {}  % No extra formatting
\titlespacing*{\subsubsection}{0pt}{0pt}{0pt}[0pt]  % Adjust spacing around subsubsection title
%===============================================================
...
%=============================文献格式===============================
\usepackage[numbers,authoryear]{natbib}         % 引用哈佛格式
...
\nocite{*}
\bibliographystyle{dcu}  % 使用Harvard格式
\bibliography{./reference/thesis}  % 指向bib文件

\titleformat{\section}[hang]{\heiti\large}{Appendix\,\thesection \quad}{0pt}{}{}
\input{appendix.tex}
