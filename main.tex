...
\pagestyle{fancy}
\fancyhf{}
\lhead{\includegraphics[scale=0.03]{./pictures/ICL_logo.png}}
\usepackage{lastpage}
\rhead{\small\bfseries Title}
%===============================================================
...
\setlength{\parskip}{0.5ex plus 0.1ex minus 0.1ex} % 段落间距
\titleformat{\section}[hang]{\bfseries\Large}{Chapter\ \thesection \quad}{0pt}{}{}
\titleformat{\subsection}[hang]{\bfseries\normalsize\raggedright}{\thesubsection\quad}{0pt}{}{}
\titleformat{\subsubsection}[hang]{\normalsize\kaishu\raggedright}{\thesubsubsection\quad}{0pt}{}{}
\titlespacing*{\section}{0pt}{0pt}{8pt}[0pt]
\titlespacing*{\subsection}{0pt}{6pt}{4pt}[0pt]
\titlespacing*{\subsubsection}{0pt}{6pt}{4pt}[0pt]
%===============================================================

%============================目录===============================
\usepackage{titletoc}
\titlecontents{section}[1.2em]{}{}{}{}[]  % 修改section的缩进
\dottedcontents{section}[1.2em]{\normalsize}{1.0em}{4pt}  % 修改section的起始缩进
\dottedcontents{subsection}[3.2em]{\normalsize}{2.0em}{4pt}
\dottedcontents{subsubsection}[5.2em]{\normalsize}{3.0em}{4pt}
%===============================================================
...
\usepackage{xfrac}%行内小分式
\setlength{\belowcaptionskip}{-10pt} %减少图表标题下方的行距
%==================================================================
...
\phantomsection 
%设置“幻影标题”，解决额外插入目录（\addcontentsline）后总是引用到第一页的问题；
...
\titleformat{\section}[hang]{\bfseries\large}{Appendix\,\thesection \quad}{0pt}{}{}
\input{appendix.tex}
